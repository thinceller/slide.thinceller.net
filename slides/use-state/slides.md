...
<img src="/use-state-1.png" class="h-80 mx-auto rounded-lg shadow-lg" />
...
<img src="/use-state-2.png" class="h-40 mx-auto mt-4 rounded-lg" />
...
<img src="/use-state-3.png" class="h-60 mx-auto mt-4 rounded-lg shadow-lg" />
